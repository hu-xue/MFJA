...
# set -e
# lr=4e-4  #学习率
NCCL_P2P_LEVEL=NVL python tracking/train.py --script mfja --config rgbt --save_dir ./output --mode multiple --nproc_per_node 4
# mkdir ./models
# ckpt_path="./output/checkpoints/train/mfja/rgbt-$lr/ETrack_ep0020.pth.tar"
# cp $ckpt_path ./models
# mv ./models/ETrack_ep0020.pth.tar ./models/ETrack_rgbt-4e-4.pth.tar 
